  ...
  return (
    <section class="relative overflow-hidden py-10 pt-10 lg:py-10 pt-10">
      ...
      <div class="relative mx-auto grid max-w-7xl items-center gap-12 px-4 lg:grid-cols-2 lg:gap-16 lg:px-6">
        <div>
          <p class="gradient-text text-lg font-semibold md:text-xl">
            Space exploration.
          </p>
          <h1 class="mt-2 text-4xl font-extrabold tracking-tight text-slate-900 md:text-5xl lg:text-5xl dark:text-white">
            Discover the cosmos.
          </h1>
          ...
          <a
            href="#apod"
            class="mt-8 inline-flex items-center gap-2 rounded-full border border-slate-300 bg-slate-900 px-6 py-3 text-sm font-semibold text-white shadow-lg transition hover:bg-slate-800 dark:border-white/20 dark:bg-white/10 dark:hover:bg-white/20"
          >
            Get Started
            <svg
              class="h-4 w-4"
        ...
        <div class="globe-wrap relative flex min-h-[280px] items-center justify-center lg:min-h-[400px]">
          <video
            width="640"
            height="360"
            controls
